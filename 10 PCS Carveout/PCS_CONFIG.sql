...
---------------------------------------------------------------------
CREATE OR REPLACE TABLE PCS_CONFIG (
...
INSERT INTO PCS_CONFIG (RECEIVER_CODE, BILLING_MONTH, DOLLAR_PER_UNIT, CARVE_PERCENTAGE, OTHER_BA, NATURAL_ACCOUNT, MONTHS_IN_FUTURE, HALF_MONTH, LAG_MONTH)
VALUES
